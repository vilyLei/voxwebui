(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["CoMaterial"] = factory();
	else
		root["CoMaterial"] = factory();
...
function createLineMaterial(dynColorEnabled = true) {
  return CoRScene.createLineMaterial(dynColorEnabled);
}

exports.createLineMaterial = createLineMaterial;

function createQuadLineMaterial(dynColorEnabled = true) {
...
/* harmony import */ var _entry__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("c60b");
