(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["PBREffect"] = factory();
	else
		root["PBREffect"] = factory();
...
class PBREffectInstance {
  ...
  createTexture(hdrBrnEnabled) {
    return this.m_specularBuilder.createTexture(hdrBrnEnabled, this.m_rscene);
  }
...
exports.PBREffectInstance = PBREffectInstance;

function create() {
  return new PBREffectInstance();
}
...
/* harmony import */ var _entry__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("a273");
