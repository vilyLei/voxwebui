...
class CtrlItemObj implements ICtrlItemObj {
    ...
    type = "";
    uuid = "";
    btn: SelectionEntity | ProgressEntity = null;
     ...
     * 将 颜色 值由ui发送到外面
     */
    sendColorOut(color: IColor4, force: boolean = false): void {
        let param = this.param;
        let vs = this.color;
        color.toArray3(vs);
    ...
    updateParamToUI(): void {
        ...
        switch (param.type) {
            ...
            case "number":
                ...
                const b0 = this.btn as ProgressEntity;
            ...
            case "progress":
                ...
                const b1 = this.btn as ProgressEntity;
            ...
            case "status_select":
                ...
                const b2 = this.btn as SelectionEntity;
                if (t.flag) {
                    b2.select(false);
                }
                else {
